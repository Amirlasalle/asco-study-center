        ...
        <Container fluid secondary="true" className="d-flex flex-wrap justify-content-around mt-3">
          ...
          <Carousel slide={false}>
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption>
                <h2 className='position-relativeslide-title outlined-text'>ASCO Power Technologies and the NTS{'(Non-Automatic Transfer Switch)'} and why it might be a great alternative for a Manual Transfer Switch.</h2><br></br>
                <Button variant="info" size="md" ><a href='https://www.youtube.com/watch?v=lbs_BC8cQwo' target="_blank" rel="noreferrer" className="btn1" >Learn More</a></Button>
              </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
