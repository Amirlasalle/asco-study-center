      ...
      <Container fluid secondary="true" className="d-flex flex-wrap justify-content-around home">
        ...
        <Carousel slide={false} nextIcon={<FontAwesomeIcon icon={faChevronRight} />} style={nextIconStyle}
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className='d-flex flex-column justify-content-center  text-center outlined-text'>
              <h className='  outlined-text'>ASCO Power Technologies ensures uninterrupted operational performance</h><br></br><br></br><br></br><br></br><br></br>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className='mt-0 mb-auto d-flex flex-column justify-content-center   outlined-text text-center'>
              <h className='  outlined-text'>Keep seeking knowledge!</h><br></br><br></br><br></br><br></br><br></br>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className='mt-0 mb-auto d-flex flex-column justify-content-center   outlined-text text-center'>
              <h className='outlined-text'>Meet the people of ASCO, and hear their story. Strive to the top!</h><br></br><br></br><br></br><br></br><br></br>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className='mt-0 mb-auto d-flex flex-column justify-content-center   outlined-text text-center'>
              ...
              <h className='  outlined-text'>ASCO Quick Connects ensure a reliable way to connect generators to infrastructures.</h><br></br><br></br><br></br><br></br><br></br>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className='mt-0 mb-auto d-flex flex-column justify-content-center   outlined-text text-center'>
              <h className='  outlined-text'>ASCO's Digital Binder provides a various source of information</h><br></br><br></br><br></br><br></br><br></br>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className='mt-0 mb-auto d-flex flex-column justify-content-center   outlined-text text-center'>
              <h className='  outlined-text'>Data Centers nationwide trust ASCO for unmatched reliability</h><br></br><br></br><br></br><br></br><br></br>
              <Button variant="info" size="md" className="carousel-btn btn-block mx-auto" style={{ maxWidth: '250px' }}><a href='https://www.youtube.com/watch?v=3zNO-2RBqKY' target="_blank" rel="noreferrer" className="btn1" >Customer Testimonials <span><i class="fa fa-external-link" aria-hidden="true"></i></span></a></Button>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption className='mt-0 mb-auto d-flex flex-column justify-content-center   outlined-text text-center'>
              <h className='  outlined-text'>Residential Healthcare meets our Backup Power Solutions</h><br></br><br></br><br></br><br></br><br></br>
