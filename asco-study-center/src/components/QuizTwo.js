...
import quizcentertwoData from './quizcentertwo.json';
import 'bootstrap/dist/css/bootstrap.min.css';
import '../App.css';
import { Link } from 'react-router-dom';


function QuizCenterTwo() {
  ...
  const [quizData] = useState(quizcentertwoData);
    ...
    <Container className="mb-5 mt-5">
      <div className="d-flex flex-wrap justify-content-around">
        ...
        <section className='mt-5'
          href="#quizcentertwo"
        ><Link to="/quizcentertwo" ><Button className="btn btn-danger" onClick={restartQuiz}>Retake Quiz</Button></Link>
        </section>
      </div>
    </Container>
  );
