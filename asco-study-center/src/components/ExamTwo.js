...
import examtwoData from './examtwo.json';
...
function ExamTwo() {
  ...
  const [examData] = useState(examtwoData);
    ...
    <Container className="mb-5 mt-5">
      <div className="d-flex flex-wrap justify-content-around">
        ...
        <section className='mt-5'
          href="#examtwo"
        ><Link to="/examtwo" ><Button className="btn btn-danger" onClick={restartExam}>Retake Exam</Button></Link>
        </section>
      </div>
    </Container>
  );
